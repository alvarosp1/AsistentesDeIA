...
• Atender hasta 100 conversaciones simultáneas
• Generar reportes básicos de rendimiento
• Automatizar tareas repetitivas de un departamento
• Integrarse con 1 plataforma (ej: WhatsApp)`
      },
      { text: "Horario 24/7", included: true },
      { text: "Respuestas Automáticas", included: true },
      { text: "Integración WhatsApp", included: true },
      { text: "Reportes Básicos", included: true },
      { text: "Personalización Básica", included: true },
      { text: "Soporte por Email", included: true },
      { text: "Análisis de Sentimientos", included: false },
      { text: "Integración con CRM", included: false },
      { text: "Asistente Multilingüe", included: false },
    ],
    popular: false,
  ...
  },
  {
    ...
    features: [
      { 
        ...
        included: true,
        hasInfo: true,
        tooltip: `Con 3 Asistentes Virtuales podrás:

• Gestionar múltiples áreas (ej: ventas + soporte + marketing)
• Atender hasta 500 conversaciones simultáneas
• Coordinar tareas entre departamentos
• Generar reportes cruzados entre áreas
• Integrarse con 3 plataformas diferentes`
      },
      { text: "Horario 24/7", included: true },
      { text: "Respuestas Avanzadas", included: true },
      { text: "Integración WhatsApp y Email", included: true },
  ...
  },
  {
    ...
    features: [
      { 
        ...
        included: true,
        hasInfo: true,
        tooltip: `Con Asistentes Ilimitados podrás:

• Gestionar todas las áreas de tu empresa
• Atención ilimitada de conversaciones
• Coordinación completa entre departamentos
• Sistema de reportes empresarial completo
• Integración con todas las plataformas necesarias`
      },
      { text: "Horario 24/7", included: true },
      ...
      { text: "Asistente Multilingüe", included: true },
    ],
    popular: false,
